package com.abramchik.spring.rest.configuration;
...
@Configuration
@ComponentScan(basePackages = "com.abramchik.spring.rest")
@EnableWebMvc
...
public class MyConfig {
    ...
    public LocalSessionFactoryBean sessionFactory(){
        ...
        sessionFactory.setPackagesToScan("com.abramchik.spring.rest.entity");
